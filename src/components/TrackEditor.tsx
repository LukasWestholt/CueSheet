...
export default function TrackEditor({
  ...
  // Known move names for the step-name <datalist>, A–Z. iOS shows the native
  // picker via a small chevron on the input — which the old quarter-width
  // field had no room for, hence the full-width name field on phones
  // (styles.css); the input stays free text for brand-new moves.
  ...
  return (
    <div className="editor">
      ...
      {/* Native autocomplete for the step-name inputs (all known moves, A–Z). */}
      {moveNames.length > 0 && (
